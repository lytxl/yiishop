...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="<?=\yii\helpers\Url::to(['list/search'])?>" name="serarch" method="get" class="fl">
                    <input name="goods_name" id="search" type="text" class="txt" placeholder="请输入商品关键字"/>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="uclist mt10">
                        <ul class="list1 fl">
                            <li><a href="">用户信息></a></li>
                            <li><a href="<?=\yii\helpers\Url::to(['list/order-select'])?>">我的订单></a></li>
                            <li><a href="<?=Yii::$app->user->isGuest?\yii\helpers\Url::to(['site/member-login']):\yii\helpers\Url::to(['site/site-index','id'=>Yii::$app->user->identity->getId()])?>">收货地址></a></li>
                            <li><a href="">我的收藏></a></li>
                        </ul>
        ...
        <div class="cart fl">
            <dl>
                <dt>
                    <a href="<?=\yii\helpers\Url::to(['list/cart'])?>">去购物车结算</a>
                    <b></b>
                </dt>
                <dd>
                    <div class="prompt">
    ...
    <div class="nav w1210 bc mt10">
        <!--  商品分类部分 start-->
        <div class="category fl <?=Yii::$app->request->getPathInfo()==''?'':'cat1'?> ">
...
<script type="text/javascript">
    $('#search').keyup(function () {
        if($('#search').val()==''){
            $('#my_input').prop('disabled','disabled')
        }else{
...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <h3><strong><?=$form->content?></strong></h3>

            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$img_one?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$img_one?>" alt="" width="300px" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img_one?>',largeimage: '<?=$img_one?>'}"><img src="<?=$img_one?>"></a>
                            </li>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="star"><span>商品热度：</span> <strong></strong><a href="">(已有<?=$goods->view_times?>人查看)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?=\yii\helpers\Url::to(['list/add-to-cart'])?>" method="get" class="choose">
                    <ul>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <?php endforeach;?>
                        <p style="height:10px;"><?=$form->content?></p>
                    </div>
