                ...
                <ul>
                    ...
                    <li>
                        ...
                        <script type="text/javascript">
                            addressInit('cmbProvince', 'cmbCity', 'cmbArea',"<?=$form->cmbProvince?>","<?=$form->cmbCity?>","<?=$form->cmbArea?>");
                        </script>
                    </li>
                    <li>
                        <label for=""><span>*</span>详细地址：</label>
                        <input type="text" name="detailed" class="txt address" value="<?=$detail->detailed?>"  />
                    </li>
                    <li>
                        <label for=""><span>*</span>手机号码：</label>
                        <input type="text" name="cel" class="txt" value="<?=$form->cel?>" />
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
